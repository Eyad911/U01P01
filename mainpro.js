...
{ 
    ...
    extraimg:["https://5msh.com/wp-content/uploads/2021/02/%D8%A7%D8%B3%D8%B9%D8%A7%D8%B1-%D9%88%D8%AC%D8%A8%D8%A7%D8%AA-%D9%83%D9%86%D8%AA%D8%A7%D9%83%D9%89.png","https://americana-group.com/app/uploads/2017/11/kfc.jpg","https://www.ngmisr.com/wp-content/uploads/2019/06/%D8%A7%D9%84%D8%B1%D9%82%D9%85-%D8%A7%D9%84%D9%85%D9%88%D8%AD%D8%AF-%D9%83%D9%86%D8%AA%D8%A7%D9%83%D9%8A-%D8%A7%D9%84%D8%B3%D8%B9%D9%88%D8%AF%D9%8A%D8%A9-%D9%85%D9%86%D9%8A%D9%88-%D9%83%D9%86%D8%AA%D8%A7%D9%83%D9%8A.jpg","https://5msh.com/wp-content/uploads/2021/02/%D8%A7%D8%B3%D8%B9%D8%A7%D8%B1-%D9%88%D8%AC%D8%A8%D8%A7%D8%AA-%D9%83%D9%86%D8%AA%D8%A7%D9%83%D9%89.png","https://americana-group.com/app/uploads/2017/11/kfc.jpg","https://www.ngmisr.com/wp-content/uploads/2019/06/%D8%A7%D9%84%D8%B1%D9%82%D9%85-%D8%A7%D9%84%D9%85%D9%88%D8%AD%D8%AF-%D9%83%D9%86%D8%AA%D8%A7%D9%83%D9%8A-%D8%A7%D9%84%D8%B3%D8%B9%D9%88%D8%AF%D9%8A%D8%A9-%D9%85%D9%86%D9%8A%D9%88-%D9%83%D9%86%D8%AA%D8%A7%D9%83%D9%8A.jpg"],
},
{ 
    name: 'MacdonaldFC',
    discription: 'FastFood',
    ...
    extraimg:["https://www.qaym.com/54163.jpg","https://images.deliveryhero.io/image/talabat/menuitems/Grand_Chicken_Specia_637130050954072607.jpg","https://i1.wp.com/www.sopitas.com/wp-content/uploads/2015/12/hero_pdt_favouritesau-597x320.png"]
},
{ 
    name: 'Hardees',
    discription: 'FastFood',
    ...
    extraimg:["https://storage.eu.content-cdn.io/am-resources/8e05005e-5364-4850-94cf-2e54e2242528/Images/userimages/Chargrilled_burgers.png","https://americana-group.com/app/uploads/2017/11/Hardees.jpg","https://pbs.twimg.com/ext_tw_video_thumb/1440745850326585350/pu/img/c3w9mj5kyhqCZpxK.jpg"]
},
{ 
    name: 'Burger King',
    discription: 'FastFood',
    ...
    extraimg:["https://miro.medium.com/max/1400/0*FtMqkN_p_FndN9j7.jpg","https://cdn-images-1.medium.com/max/1200/1*pIJH1mPega8583Y3NuPaLg.jpeg","https://d1xrg67pith2aj.cloudfront.net/images/store_facade_image/HJFLO4Sjg-main.jpeg?1493019515366"]
},
{ 
    name: 'dominos',
    discription: 'FastFood',
    ...
    extraimg:["https://diginomica.com/sites/default/files/images/2017-05/dominos.jpg","https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/domino-s-thechick-ain-t-vegannuggets1-1608288780.jpg","https://www.totallyveganbuzz.com/wp-content/uploads/2020/01/Dominos-Vegan-pizza_TotallyVeganBuzz-1280x720.jpg"]
}
 ];
 ...
 const deleteItem = (index) => {
  ...
  $(".hideDiv").hide();
  $(`.infoDev`).show();
  $(`.infoDev`).append(`<img src="${foodList[i].imgUrl}" id= "infoImg" alt="logo"/> 
  <div id ="infohp-${i}">
...
foodList[i].extraimg.forEach((item,i) => {
 ...
 const render = () => {
    ...
    foodList.forEach((item, i) => {
        $(".imgHolder").append(`<div class="div1" id= "info-${i}">
        <h1>${item.name}</h1>
...
$('#removeBtn-'+ i).click(() => {deleteItem(i);});
$(`#info-`+i).click(()=> { itemInfo(i) });
    })   
    // نهاية اللوب
 }
 ...
 const addToList = () => {
    ...
    // // $(`.hideDiv`).css( "visibility", "show" );
    // $(".div1").append(` <div class='hideDiv'>
    // <input type="text" id='inpName'placeholder="Name" />
    // <input type="text" id='inpDisc' placeholder="Discription" />
    // <input type="text" id='inpUrl' placeholder="Img URL" />
    // </div>
    // `)
